...
//! address before the deadline: the retired `-32002` error code, stateful-session reliance,
//! deprecated roots / sampling / logging, and OAuth without Protected Resource Metadata.
//!
